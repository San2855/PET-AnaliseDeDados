...
# Abre o arquivo CSV
with open('Teste\Dados_PET\ITM-22-111-Am-08-CBI22-077-Cons_Agua-_Final-05-01-23_.csv', 'r') as arquivo_csv:
    # Lê o arquivo CSV
    ...
    conexao = sqlite3.connect('Cons_Agua.db')
    ...
    # Conecta ao banco de dados SQLite3
    conexao = sqlite3.connect('Step_Cons_Agua.db')
