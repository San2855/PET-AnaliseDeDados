...
# Abre o arquivo CSV
with open('Teste\Dados_PET\ITM-22-111-Am-08-CBI22-077-Form_Prototipo-_Final-05-01-23_.csv', 'r') as arquivo_csv:
    # Lê o arquivo CSV
    ...
    conexao = sqlite3.connect('Form_Prototipo.db')
    ...
    # Conecta ao banco de dados SQLite3
    conexao = sqlite3.connect('Step_Form_Prototipo.db')
    ...
    # Insere as informações do arquivo CSV na tabela "rel"
